...
1. `load_tiny_shakespeare_text` returns a bounded raw text slice.
...
- [X] Session 1: implement `load_tiny_shakespeare_text` and inspect a short corpus slice.
- [X] Session 2: implement `CharacterTokenizer.fit`, `encode`, and `decode`.
